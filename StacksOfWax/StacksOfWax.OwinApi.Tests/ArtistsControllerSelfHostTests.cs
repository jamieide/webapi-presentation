...
namespace StacksOfWax.OwinApi.Tests
{
    ...
    public class ArtistsControllerSelfHostTests
    {
        ...
        {
            _webApp = WebApp.Start<Startup>("http://localhost:50263/");
        }
        ...
        public void CanGetArtists()
        {
            ...
            {
                // Arrange
                var requestUri = new Uri("http://localhost:50263/api/artists");
        ...
        public void CanGetArtist()
        {
            ...
            {
                // Arrange
                var requestUri = new Uri("http://localhost:50263/api/artists/1");
